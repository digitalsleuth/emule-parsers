...
"""
This script parses the server.met file from eMule (0.50a - 0.51d)
It is possible this script will parse earlier versions, however this has not been tested.
